<?php
    ...
    // Function: The file fetches the items in a product
    // catalog and managing a shopping cart for placing 
    // orders via interaction with an XML data store. Besides that, it provides 
    // a series of functions according to various AJAX requests on the part 
    // of client-side JavaScript to provide for adding/removing items from 
    // the cart, confirming/canceling purchases, and updating the 
    // XML file in response to changes in product availability and sales. The
    // quantity number and the quantity on hold and quantity sold are the xml tags which are 
    // modified based on that logic.
